...
public enum SentenceType {
  ...
  PVA_DEF(new SentenceBuilder("src/main/resources/sentences/pva_def_sentence.json")),
  PVA_TEMP(new SentenceBuilder("src/main/resources/sentences/pva_temp_sentence.json")),
